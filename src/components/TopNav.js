    ...
    return (
        <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
            <div className='flex items-center'>
                ...
                <h1  className='text-2xl sm:text-3xl lg:text-4xl px-2'>Raj
                    <span className='font-bold text-orange-700'>Bhog</span>
                </h1>
            ...
            <button className='bg-orange-700 text-white hidden md:flex items-enter py-2 rounded-full'>
            ...
            <div className={
                ...
                <h2 className='text-2xl p-4'>Raj <span className='text-orange-700 font-bold'>Bhog</span></h2>
                <nav>
